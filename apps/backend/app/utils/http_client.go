...
import (
	...
	"github.com/fadilmartias/dilz_code/apps/backend/app/logger" // Import global logger mu
...
// Gunakan satu base client global jika memungkinkan, tapi untuk kemudahan API chainable
// kita bisa bikin instance per struct.
...
// Http returns a fresh client wrapper ready for chaining.
...
func (h *HttpClient) do(method, rawURL string) (*fiberclient.Response, error) {
	...
	// Catat log sebelum request berangkat
